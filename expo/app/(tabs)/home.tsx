...
import { Award, Users, QrCode, Search, Star, X, MapPin, Navigation, Camera, User, Gift, UserPlus, Zap, Heart, Clock, Sparkles, AlertCircle, Upload, CheckCircle, Send } from 'lucide-react-native';
              ...
              <View style={styles.btBreakdownCard}>
                <View style={styles.btBreakdownItem}>
                  <View style={styles.btBreakdownHeader}>
                    ...
                    <Text style={styles.btBreakdownLabel}>技術力</Text>
                  </View>
                  <View style={styles.btBreakdownValueColumn}>
                    <View style={styles.btBreakdownValue}>
                      <Text style={styles.btBreakdownAmount}>{btDistribution.technical}</Text>
                      <Text style={styles.btBreakdownUnit}>BP</Text>
                    </View>
                    {pendingBTDistribution.technical > 0 && (
                      <Text style={styles.pendingBPText}>+{pendingBTDistribution.technical}（仮）</Text>
                    )}
                  </View>
                </View>
